      ...
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <div className="space-y-4 mb-10">
          {services.map((service, index) => (
            <div key={index} className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-orange-500/40 transition-all duration-200 text-left">
